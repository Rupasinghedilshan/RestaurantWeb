...
//Login ----------------------------
	if(isset($_POST['btnLogin'])){
		...
		if($userType['utype_fk'] == '1'){
			...
			$_SESSION['uname'] = $uname_log;
			header('Location: waiterMain.php');
		}
...
//update category details
	if(isset($_POST['updateCatbtn']))
	{
		...
		$query = "UPDATE food_category SET catname='$catname', cuisine='$cuisine' WHERE catid='$catid' ";
		$query_run = mysqli_query($connection, $query);
...
if(isset($_POST['addCategorybtn']))
	{    
		...
		$cuisine = $_POST['cuisine'];
			...
			$query = "INSERT INTO food_category(catname,cuisine) VALUES ('$catname','$cuisine')";
			$query_run = mysqli_query($connection, $query);
