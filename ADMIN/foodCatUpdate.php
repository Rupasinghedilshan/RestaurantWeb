		  ...
		  <!--	form-->
		  	...
		  	<div class="card-body">
				...
				<div class="form-group">
					...
					<input type="text" value="<?php echo $row['catname'] ?>" name="ecatname" class="form-control" placeholder="Enter category">
				</div>
				<div class="form-group">
					<label> cuisine </label>
					<input type="text" value="<?php echo $row['cuisine'] ?>" name="ecuisine" class="form-control" placeholder="Update cusine">
				</div>
