      ...
      <form action="admin.php" method="POST"> 
        	...
        	<div class="modal-body"> 
            	<div class="form-group">
					<label> Food ID </label>
					<input type="text" name="fid" class="form-control" placeholder="Enter food ID" > 
				</div>
				<div class="form-group">
					<label> Item Name </label>
					<input type="text" name="fname" class="form-control" placeholder="Enter Item name" > 
				</div>
				<div class="form-group">
					<label> Food category </label>
					<input type="text" name="fcat" class="form-control" placeholder="Food Category">
				</div>
				<div class="form-group">
					<label> Price </label>
					<input type="text" name="fprice" class="form-control" placeholder="Enter price">
				</div>
				<div class="form-group">
					<label> Availabilty </label>
					<input type="text" name="favail" class="form-control" placeholder="Item Availability">
				</div>
       	  	</div>                   
